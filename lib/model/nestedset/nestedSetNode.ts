import {INestedSetNode} from "~/lib/model/nestedset/inestedSetNode";
import {Annotation} from "~/lib/model/annotation";

export class NestedSetNode implements INestedSetNode {
    public depth: number;
    public left: number;
    public right: number;
    ...
    constructor(title: string = '', left: number = 0, right: number = 1, depth: number = 0, parent: NestedSetNode | null = null) {
        this.title = title;
        this.depth = depth;
        this.left = left;
        this.right = right;
    ...
    public toNestedSetProperties(): INestedSetNode {
        return {
            depth: this.depth,
            left: this.left,
            right: this.right,
